%function [T sticks_imgcoor] = NPoseEstimStillImage(base_dir, img_dir, img_fname_format, img_number, classname, bb, fghigh_pars, parse_pars, addinf_pars, segm_params, verbose)
function [T sticks_imgcoor] = NPoseEstimStillImage(classname, bb, fghigh_pars, parse_pars, addinf_pars, segm_params, verbose)
...
% parsing
[T.PM T.CM] = ParseTrack(fullfile(base_dir, img_dir), img_fname_format, [], T, false, false, parse_pars, [base_dir '/poses_' classname], verbose);
